...
namespace IronCore.DAL.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Storages_AspNetUsers_AppUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChannelUsers", x => new { x.ChannelId, x.AppUserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SendedById = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: false),
                    IsArchived = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    CreatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ArchiveDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Messages_AspNetUsers_SendedById",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Messages_Storages_StorageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Channels_IsArchived",
                table: "Channels",
                column: "IsArchived");

            migrationBuilder.CreateIndex(
                name: "IX_Channels_IsDirect",
                table: "Channels",
                column: "IsDirect");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChannelUsers_JoinedDate",
                table: "ChannelUsers",
                column: "JoinedDate");
